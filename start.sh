...
# GYSFLY Travels CRM - High-End Admin Console Bootstrapper
# Custom designed for Christian Durán / Gysfly Travels
...
echo -e "${GOLD}======================================================================${NC}"
echo ""
echo -e "${BLUE}[*] Inicializando servidor local para Gysfly Travels CRM...${NC}"
...
echo -e "   • ${TEAL}Usuario Gerente (Admin):${NC}  admin@gysfly.com  |  Clave: admin123"
echo -e "   • ${TEAL}Usuario Agente Junior:${NC}  agente@gysfly.com |  Clave: agente123"
